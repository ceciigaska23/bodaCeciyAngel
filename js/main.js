...
//     companionsList.querySelectorAll(".companion-entry").length;
...
// function openMaps() {
//   const address =
//     "Av Centenario 1100, Colinas de Tarango, Álvaro Obregón, 01620 Ciudad de México, CDMX";
...
//   const address =
//     "https://www.google.com.mx/maps/place/Lienzo+Charro+La+Tapatia/@19.3638389,-99.221547,16.25z/data=!4m6!3m5!1s0x85d200448408c8b5:0x640c20e90d659f23!8m2!3d19.3644968!4d-99.2207107!16s%2Fg%2F1tgdjbdr!5m1!1e1?hl=es&entry=ttu&g_ep=EgoyMDI1MDkwOC4wIKXMDSoASAFQAw%3D%3D";
...
//       .then(() => {
//         showLocationNotification(
//           "✅ Información compartida exitosamente",
//           "success"
//         );
//       })
//       .catch((error) => {
...
//       .then(() => {
//         showLocationNotification(
//           "✅ Info de transporte copiada al portapapeles",
//           "success"
//         );
//       })
//       .catch(() => {
...
function updateMusicButton() {
  ...
  if (musicPlaying) {
    ...
    toggle.title = "Reproducir música";
  }
}
...
function setupFormHandlers() {
  ...
  if (searchName) {
    searchName.addEventListener("keypress", function (e) {
      if (e.key === "Enter") {
        e.preventDefault();
        if (typeof window.searchGuest === 'function') {
          window.searchGuest();
        }
      }
    });
...
function copyAddress() {
  const address = "https://www.google.com.mx/maps/place/Lienzo+Charro+La+Tapatia/@19.3638389,-99.221547,16.25z/data=!4m6!3m5!1s0x85d200448408c8b5:0x640c20e90d659f23!8m2!3d19.3644968!4d-99.2207107!16s%2Fg%2F1tgdjbdr!5m1!1e1?hl=es&entry=ttu&g_ep=EgoyMDI1MDkwOC4wIKXMDSoASAFQAw%3D%3D";

  if (navigator.clipboard && window.isSecureContext) {
    navigator.clipboard.writeText(address)
      .then(() => showLocationNotification("✅ Dirección copiada al portapapeles", "success"))
...
// ===== INITIALIZATION =====
document.addEventListener("DOMContentLoaded", function () {
  console.log("🎊 DOM Cargado - Inicializando invitación");

  // CRÍTICO: Asignar evento de clic al splash screen
  const splash = document.getElementById("splashScreen");
  if (splash) {
    console.log("✅ Splash screen encontrado");
    
    splash.addEventListener("click", function(e) {
      console.log("🖱️ Click detectado en splash screen");
      startInvitation();
    });
    
    // También permitir Enter o Espacio
    document.addEventListener("keydown", function(e) {
      if ((e.key === "Enter" || e.key === " ") && splash.style.display !== "none") {
        e.preventDefault();
        console.log("⌨️ Tecla detectada");
        startInvitation();
      }
    });
    
    console.log("✅ Eventos agregados al splash screen");
  } else {
    console.error("❌ No se encontró el splash screen");
  }
